    ...
    <div class="container">
        <div class="row  justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">ปริมาณการผลิตจำแนกตามผลิตภัณฑ์ ปี 25ww</div>
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-header">ข้อมูลการผลิตในรอบปี 25ww</div>
                    <div class="card-body">
                        <table  border = 1 , bordercolor = "black">
                            <tbody>
                                <tr>
                ...
                <div class="card mb-4">
                    <div class="card-header">ข้อมูลการใช้ไฟฟ้าในรอบปี 25ww</div>
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-header">ข้อมูลการใช้เชื้อเพลิงและพลังงานหมุนเวียนในรอบปี 25ww</div>
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-header">ข้อมูลการใช้เชื้อเพลิงในการผลิตไฟฟ้าในรอบปี 25ww</div>
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-header">สัดส่วนการใช้พลังงานไฟฟ้าแยกตามระบบปี 25ww</div>
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-header">สัดส่วนการใช้พลังงานเชื้อเพลิงแยกตามระบบปี 25ww</div>
                    <div class="card-body">
