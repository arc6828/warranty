        ...
        <div class="row  justify-content-center">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form class="form-inline">
                        ...
                        <br> &nbsp;&nbsp;&nbsp;&nbsp;   พลังงานไฟฟ้าต่ำกว่าหกสิบล้านเมกะจูล/ปี 
                        </div> 
                    </form>
                    ...
                    <form class="form-inline">
                        ...
                        <br>  &nbsp;&nbsp;&nbsp;&nbsp;  พลังงานไฟฟ้าตั้งแต่หกสิบล้านเมกะจูล/ปี 
                        </div> 
                    </form>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div>
                    <label for="exampleFormControlFile1" >( ใส่ผังโครงสร้างคณะทำงานดานการจัดการพลังงาน )</label>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div>
                        <label for="exampleFormControlFile1" >( ใส่คำสั่งแต่งตั้งคณะทำงานด้านการจัดพลังงาน )</label>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div>
                            <label for="exampleFormControlFile1" >( ใส่เอกสารแสดงประกาศนโยบายอนุรัษ์พลังงาน )</label>
                        </div>
