...
<div class="form-group {{ $errors->has('enery_report_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="enery_report_id" type="number" id="enery_report_id" value="{{ isset($energycommittee->enery_report_id) ? $energycommittee->enery_report_id : ''}}" >
