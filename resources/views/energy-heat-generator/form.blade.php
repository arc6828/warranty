...
<div class="form-group {{ $errors->has('primary_fuel_consumption_type') ? 'has-error' : ''}}">
    <label for="primary_fuel_consumption_type" class="control-label">{{ 'Primary Fuel Consumption Type' }}</label>
...
<div class="form-group {{ $errors->has('primary_fuel_consumption_volume') ? 'has-error' : ''}}">
    <label for="primary_fuel_consumption_volume" class="control-label">{{ 'Primary Fuel Consumption Volume' }}</label>
...
<div class="form-group {{ $errors->has('primary_fuel_consumption_unit') ? 'has-error' : ''}}">
    <label for="primary_fuel_consumption_unit" class="control-label">{{ 'Primary Fuel Consumption Unit' }}</label>
...
<div class="form-group {{ $errors->has('electricity_use') ? 'has-error' : ''}}">
    <label for="electricity_use" class="control-label">{{ 'Electricity Use' }}</label>
...
<div class="form-group {{ $errors->has('electricity_sale') ? 'has-error' : ''}}">
    <label for="electricity_sale" class="control-label">{{ 'Electricity Sale' }}</label>
...
<div class="form-group {{ $errors->has('steam_use') ? 'has-error' : ''}}">
    <label for="steam_use" class="control-label">{{ 'Steam Use' }}</label>
...
<div class="form-group {{ $errors->has('steam_sale') ? 'has-error' : ''}}">
    <label for="steam_sale" class="control-label">{{ 'Steam Sale' }}</label>
