                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Legal Name </th><td> {{ $energyreport->legal_name }} </td></tr><tr><th> Factory Name </th><td> {{ $energyreport->factory_name }} </td></tr><tr><th> Tsic Id </th><td> {{ $energyreport->tsic_id }} </td></tr><tr><th> Year </th><td> {{ $energyreport->year }} </td></tr><tr><th> User Id </th><td> {{ $energyreport->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
