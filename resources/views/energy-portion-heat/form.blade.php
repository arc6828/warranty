...
<div class="form-group {{ $errors->has('energy_report_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="energy_report_id" type="number" id="energy_report_id" value="{{ isset($energyportionheat->energy_report_id) ? $energyportionheat->energy_report_id : ''}}" >
