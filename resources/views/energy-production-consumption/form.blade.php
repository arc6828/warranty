...
<div class="form-group {{ $errors->has('consumption_electricity') ? 'has-error' : ''}}">
    <label for="consumption_electricity" class="control-label">{{ 'Consumption Electricity' }}</label>
...
<div class="form-group {{ $errors->has('consumption_heat') ? 'has-error' : ''}}">
    <label for="consumption_heat" class="control-label">{{ 'Consumption Heat' }}</label>
...
<div class="form-group {{ $errors->has('energy_production_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="energy_production_id" type="number" id="energy_production_id" value="{{ isset($energyproductionconsumption->energy_production_id) ? $energyproductionconsumption->energy_production_id : ''}}" >
    {!! $errors->first('energy_production_id', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    <label for="user_id" class="control-label">{{ 'User Id' }}</label>
    <input class="form-control" name="user_id" type="number" id="user_id" value="{{ isset($energyproductionconsumption->user_id) ? $energyproductionconsumption->user_id : ''}}" >
...
<div class="form-group {{ $errors->has('enery_report_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="enery_report_id" type="number" id="enery_report_id" value="{{ isset($energyproductionconsumption->enery_report_id) ? $energyproductionconsumption->enery_report_id : ''}}" >
