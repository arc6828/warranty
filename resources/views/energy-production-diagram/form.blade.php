...
<div class="form-group {{ $errors->has('energy_production_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="energy_production_id" type="number" id="energy_production_id" value="{{ isset($energyproductiondiagram->energy_production_id) ? $energyproductiondiagram->energy_production_id : ''}}" readonly >
    {!! $errors->first('energy_production_id', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    <label for="user_id" class="control-label">{{ 'User Id' }}</label>
    <input class="form-control" name="user_id" type="number" id="user_id" value="{{ isset($energyproductiondiagram->user_id) ? $energyproductiondiagram->user_id : ''}}" readonly >
...
<div class="form-group {{ $errors->has('energy_report_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="energy_report_id" type="number" id="energy_report_id" value="{{ isset($energyproductiondiagram->energy_report_id) ? $energyproductiondiagram->energy_report_id : ''}}" readonly >
