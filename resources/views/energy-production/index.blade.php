...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Energyproduction</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Code</th><th>Product Name</th><th>Capacity</th><th>Yield</th><th>User Id</th><th>Enery Report Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($energyproduction as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->code }}</td><td>{{ $item->product_name }}</td><td>{{ $item->capacity }}</td><td>{{ $item->yield }}</td><td>{{ $item->user_id }}</td><td>{{ $item->enery_report_id }}</td>
                                        <td>
