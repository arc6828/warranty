<div class="form-group {{ $errors->has('energy_machine_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="energy_machine_id" type="number" id="energy_machine_id" value="{{ isset($energymachineevaluation->energy_machine_id) ? $energymachineevaluation->energy_machine_id : ''}}" >
...
<div class="form-group {{ $errors->has('power_consumption_size') ? 'has-error' : ''}}">
    <label for="power_consumption_size" class="control-label">{{ 'Power Consumption Size' }}</label>
...
<div class="form-group {{ $errors->has('operating_hours') ? 'has-error' : ''}}">
    <label for="operating_hours" class="control-label">{{ 'Operating Hours' }}</label>
...
<div class="form-group {{ $errors->has('improvement_potential') ? 'has-error' : ''}}">
    <label for="improvement_potential" class="control-label">{{ 'Improvement Potential' }}</label>
...
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="user_id" type="number" id="user_id" value="{{ isset($energymachineevaluation->user_id) ? $energymachineevaluation->user_id : ''}}" >
...
<div class="form-group {{ $errors->has('enery_report_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="enery_report_id" type="number" id="enery_report_id" value="{{ isset($energymachineevaluation->enery_report_id) ? $energymachineevaluation->enery_report_id : ''}}" >
