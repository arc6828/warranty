                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Policy Score </th><td> {{ $energyevaluation->policy_score }} </td></tr><tr><th> Organization Score </th><td> {{ $energyevaluation->organization_score }} </td></tr><tr><th> Motivation Score </th><td> {{ $energyevaluation->motivation_score }} </td></tr><tr><th> Information Score </th><td> {{ $energyevaluation->information_score }} </td></tr><tr><th> Public Relation Score </th><td> {{ $energyevaluation->public_relation_score }} </td></tr><tr><th> Investment Score </th><td> {{ $energyevaluation->investment_score }} </td></tr><tr><th> Remark </th><td> {{ $energyevaluation->remark }} </td></tr><tr><th> User Id </th><td> {{ $energyevaluation->user_id }} </td></tr><tr><th> Enery Report Id </th><td> {{ $energyevaluation->enery_report_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
